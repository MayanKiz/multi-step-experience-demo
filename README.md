# Multi-Step Browser Interaction Demo

## Description

A front-end experiment for demonstrating multi-step browser interactions, state transitions, and controlled media workflows.

## Quick Start

Open the HTML entry point in a browser or serve the repository locally. Review browser permissions before enabling media features.
